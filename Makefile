...
SRC= main.c src/builtins/builtins.c src/cmd/cmd.c src/exec/exec.c src/parser/parser.c src/cmd/shell.c src/voice_recognition/voice_recognition.c src/voice_recognition/library/miniaudio.c
OBJ= $(SRC:.c=.o)
DEP= $(SRC:.c=.d)
